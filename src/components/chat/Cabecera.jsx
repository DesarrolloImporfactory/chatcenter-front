...
const Cabecera = ({
  ...
  // opción del menú solo llevaría a una pantalla vacía. Mismo criterio que en
  // MainLayout, que tiene su propia copia de este menú.
  //
  // Se consulta con `light=1`, el modo del endpoint que resuelve con puro SQL
  // y NO llama a la Graph API: la cuota es de toda la app y la comparte
  // WhatsApp.
    ...
    <>
      ...
      >
        ...
        <div className="mt-6 overflow-y-auto h-[calc(100vh-163px)] pb-10">
          ...
          {/* Dashboard de conexión: ventas, inversión y ROAS de la cuenta.
              No es para el asesor de ventas (el back lo niega por rol). */}
          {userData?.rol !== "ventas" && (
            <a
          ...
          {/* Comentarios de Facebook.
              ...
              cfg=10 — la app nueva de Meta todavía no pasa App Review, así que
              el resto de cuentas aún no puede responder comentarios. */}
              ...
              <div className="ml-10 flex flex-col py-2">
                ...
                {tipo_configuracion === "kanban" && (
                  ...
                  >
                    ...
                    {/* whitespace-nowrap: mismo caso que en MainLayout, el
                        sangrado del submenú dejaba el texto al filo y saltaba
                        de línea al abrir el menú. */}
                    <span className="flex items-center gap-2 whitespace-nowrap">
                      Configurar agentes
                    </span>
                  </a>
