...
const HIDDEN_PLANS = new Set([23, 22]);
const SORT_ORDER = { 20: 1, 16: 2, 23: 2.5, 22: 2.5, 17: 3, 18: 4 };
...
const PROMO_PLANS = new Set([20, 16, 17, 18, 23, 22]);
const PLAN_COMUNIDAD_ID = 23;
...
const detectPlanType = (plan) => {
  ...
  if (id === 23 || id === 22) return "comunidad";
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="px-3 sm:px-4 pb-16">
        ...
        >
          ...
          {visiblePlans.map((plan) => {
            ...
            const isComunidad = planId === PLAN_COMUNIDAD_ID || planId === 22;
      ...
      <ModalCodigoPromo
        ...
        onSuccess={async ({ imagenes, angulos, unlocked_plan_id }) => {
          await refreshPlanActual();
          if (!unlocked_plan_id) navigate("/insta_landing");
        }}
