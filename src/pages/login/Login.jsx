...
import "./login.css";
//detecta si el usuario ya está logueado
...
const Login = () => {
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 p-5 items-center min-h-screen">
      ...
      <div>
        ...
        >
          ...
          />
          {errors.con && (
            <p className="text-red-500 text-sm mb-4">{errors.con.message}</p>
          )}
