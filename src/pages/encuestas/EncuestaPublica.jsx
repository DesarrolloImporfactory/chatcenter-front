...
function PreviewBanner() {
  return (
    <div className="mx-6 mt-4 px-3.5 py-2 rounded-xl bg-amber-50 border border-amber-200 flex items-center gap-2">
  ...
  return (
    <div className="min-h-screen bg-[#0a0e1a] flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-md">
        <div className="bg-white rounded-3xl shadow-2xl shadow-black/40 border border-white/10 overflow-hidden ring-1 ring-white/5">
          {/* Header */}
          <div className="relative px-6 pt-7 pb-5 bg-gradient-to-br from-slate-800 via-slate-900 to-gray-900">
            ...
            <div className="relative flex items-center gap-3.5">
              <div className="w-12 h-12 rounded-2xl bg-white/10 backdrop-blur-sm border border-white/10 flex items-center justify-center shrink-0">
                <i className="bx bx-message-rounded-dots text-white text-2xl" />
              </div>
                      ...
                      <div className="flex justify-center gap-2.5">
                        {EMOJIS.map((item) => (
                          <button
                            ...
                            className={`flex flex-col items-center gap-1.5 p-3.5 rounded-2xl border-2 transition-all duration-200 min-w-[62px] ${
                              selectedScore === item.score
                                ? `${item.active} ring-2 scale-110 shadow-lg`
                                : "border-gray-100 hover:border-gray-200 hover:bg-gray-50/50"
                            }`}
                          >
                            <span
                              className={`text-2xl transition-transform ${selectedScore === item.score ? "scale-110" : ""}`}
                            >
                              {item.emoji}
                            </span>
                            <span
        ...
        <span className="text-[10px] text-white/20">Encuesta generada por</span>
