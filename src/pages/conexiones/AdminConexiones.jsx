                ...
                <table className="w-full text-sm text-slate-700">
                  <thead className="bg-slate-50 border-b border-slate-200">
                    <tr>
                      ...
                      {/* ORDENAR POR CANTIDAD DE CONVERSACIONES */}
                      <th className="py-3 px-4 text-left font-semibold cursor-pointer select-none group">
                    ...
                    {paginaActualData.map((config) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          <td className="py-3 px-4">
                            <span className="px-3 py-1 rounded-lg bg-slate-800 text-white text-xs font-semibold shadow-sm">
