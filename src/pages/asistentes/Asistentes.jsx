...
const Asistentes = () => {
  ...
  return (
    <div className="p-5">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 mb-6">
        <div className="bg-white border rounded-2xl p-5 shadow-sm hover:shadow-md transition">
          ...
          <div className="mt-4 space-y-2 text-sm text-gray-700">
            ...
            <div className="flex items-start gap-2">
              <i className="bx bx-check text-lg text-emerald-600 -mt-1" />
              <span>Tipo de venta y nombre del asistente</span>
            </div>
          </div>
        ...
        <div className="lg:col-span-2 bg-white border rounded-2xl shadow-sm hover:shadow-md transition p-6 relative">
          <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start gap-3 mb-3">
            ...
            <div className="flex items-center gap-2">
              <span
                className={`inline-flex items-center gap-2 px-3 py-1 rounded-full text-sm font-semibold ${colorEstado(iaVentasConectada)}`}
              >
                <span
                  className={`w-2 h-2 rounded-full ${iaVentasConectada ? "bg-emerald-600" : "bg-rose-600"}`}
                />
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-3 mt-4">
            ...
            <div className="rounded-2xl border border-gray-100 bg-gray-50 p-4">
              ...
              <div className="font-semibold text-gray-900 mt-1">
                {asistenteVentas?.nombre_bot || "Sin configurar"}
              </div>
            </div>
            <div className="rounded-2xl border border-gray-100 bg-gray-50 p-4">
          ...
          <div className="space-y-3">
            <div className="rounded-2xl border border-gray-100 p-4">
              <div className="flex items-center justify-between">
                ...
                <span
                  className={`text-xs font-semibold px-2 py-1 rounded-full ${existeAsistente ? "bg-emerald-100 text-emerald-700" : "bg-rose-100 text-rose-700"}`}
                >
            ...
            <div className="rounded-2xl border border-gray-100 p-4">
              <div className="flex items-center justify-between">
                ...
                <span
                  className={`text-xs font-semibold px-2 py-1 rounded-full ${iaVentasConectada ? "bg-emerald-100 text-emerald-700" : "bg-rose-100 text-rose-700"}`}
                >
            ...
            <div className="mt-3 rounded-2xl border border-amber-200 bg-amber-50 p-4">
              <div className="flex items-start gap-3">
                ...
                <div className="text-sm text-amber-900">
                  ...
                  <div className="mt-1">
                    Después de crear su API Key, verifique que su cuenta tenga
                    saldo/crédito. Sin saldo, el asistente no responderá
                    mensajes.
                  </div>
                </div>
              </div>
      ...
      {/* Modal Ventas — solo config del bot, sin remarketing */}
      {showModalVentas && (
        <div className="fixed inset-0 bg-black/50 flex justify-center items-center z-50 p-4">
          <div className="bg-white rounded-2xl shadow-2xl w-full max-w-lg p-6 space-y-5 border border-gray-100">
            <div className="flex items-start justify-between gap-3">
              <div>
                ...
                <p className="text-sm text-gray-600 mt-1">
                  Defina el nombre del bot, el tipo de venta y si debe estar
                  activo.
                </p>
              </div>
              <button
            ...
            <div className="space-y-4">
              ...
              <div className="rounded-2xl border border-gray-100 bg-gray-50 p-4">
                ...
                <p className="text-sm text-gray-600 mt-1">
                  El prompt base se carga automáticamente según el tipo de venta
                  seleccionado (
                ...
                <label className="flex items-center gap-3 cursor-pointer">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-500 mt-0.5">
                      Si está desactivado, el asistente no responderá
                      automáticamente.
                    </p>
                  </div>
                </label>
