// src/pages/kanban/configuracion/modales/InstaladorPlantillasModal.jsx
//
// Modal del instalador de plantillas Kanban: elegir la plantilla/asistente,
// personalizar (empresa, país) y aplicarla con la animación de progreso.
// Vivía dentro de componentes/PlantillasKanban.jsx (2.100+ líneas); ese
// archivo quedó como el botón disparador y este es el modal completo.
// Se monta solo cuando está abierto: el padre lo renderiza condicionalmente,
// así que todo el estado (paso, selección, resultado) nace limpio en cada
// apertura y no hay que resetear nada a mano.
...
const InstaladorPlantillasModal = ({
  id_configuracion,
  onPlantillaAplicada,
  onClose,
}) => {
  ...
  // Antes esto era handleAbrir (abría el modal y cargaba). Ahora el modal
  // nace abierto, así que solo carga las plantillas al montarse.
  const cargarPlantillas = async () => {
    ...
    try {
      ...
      const ES_DANIEL =
        Number(id_configuracion) === 277 || Number(id_configuracion) === 10;
...
export default InstaladorPlantillasModal;
